...
- Testnet transaction-free diagnostics: public-address-only preflight,
  ...
  limit, max-weight clipping, and exact SDK-compatible u16 vector. The readback
  correctly failed closed when queried without a later update. These
  diagnostics are not registration, submission, finality, or protocol
  execution evidence.
